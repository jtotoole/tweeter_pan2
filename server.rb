...
def combine (array_of_strings)
  ...
  super_array.delete("you")
  super_array.delete("should")
  super_array.delete("one")
  super_array.delete("if")
  super_array.delete("why")
  super_array.delete("what")
  super_array.delete("this")
